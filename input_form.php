...
<!--           <p></p>
 -->        </header>
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select class="form-control" id="contributionType" name="contributionType">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="url" class="form-control" id="publicationLink" name="publicationLink" placeholder="Enter publication link (DOI) as URL. e.g. https://doi.org/10.1016/j.cageo.2020.104423">
        </div>
      </div>
...
<!----------------------------------->    
 ...
 <div class="container">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select multiple class="form-control js-example-tags" id="prospectionType" name="prospectionType">
        ...
        <div class="form-group row">
            <div class="col-sm-10">
              <input type="text" class="form-control" id="prospectionType_new" name="prospectionType_new" placeholder="Enter new methods here (comma separated)">
            </div>
      </div>
  ...
  <!-- TODO replace by bhecklist -->
      ...
      <div class="form-group row">
        ...
        <div class="form-group row">
            <div class="col-sm-10">
              <input type="text" class="form-control" id="prospectionType_new" name="prospectionType_new" placeholder="Enter new scale here (comma separated)">
            </div>
      </div>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select multiple class="form-control" id="TemporalScale" name="TemporalScale">
      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          <div class="form-check">
            <input class="form-check-input" type="radio" id="TemperatureNo" name="Temperature" value="no" checked>
            <label class="form-check-label" for="TemperatureNo">
              No
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" id="TemperatureYes" name="Temperature" value="yes">
            <label class="form-check-label" for="permanentSetupYes">
              Yes
            </label>
          </div>
        </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="instrument" name="instrument" placeholder="Enter instrument(s) used">
      </div>
    </div>
...
<!--TODO add timelapse or not -->
    ...
    <fieldset class="form-group">
      <div class="row">
        ...
        <div class="col-sm-10">
          <div class="form-check">
            <input class="form-check-input" type="radio" id="permanentSetupNo" name="permanentSetup" value="no" checked>
            <label class="form-check-label" for="permanentSetupNo">
              No
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" id="permanentSetupYes" name="permanentSetup" value="yes">
            <label class="form-check-label" for="permanentSetupYes">
              Yes
            </label>
          </div>
...
<!----------------------------------->    
 ...
 <div class="container">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <select multiple class="form-control" id="licence_soft" name="licence_soft">
        ...
        <div class="form-group row">
            <div class="col-sm-10">
              <input type="text" class="form-control" id="prospectionType_new" name="prospectionType_new" placeholder="Enter new software licence type here">
            </div>
      </div>
...
<!--           <p></p>
 -->        </header>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="water" name="water" placeholder="e.g. irrigated, rain-fed">
      </div>
    </div>
        <div class="form-group row">
          <label for="comment" class="col-sm-2 col-form-label">Comment</label>
...
<!--           <p></p>
 -->        </header>
      ...
      <div class="form-group row">
        <label for="notebook_purpose" class="col-sm-2 col-form-label">Ancillary measurements</label>
        <div class="col-sm-10">
          <select multiple class="form-control" id="Ancillary_meas" name="Ancillary_meas">
      ...
      <div class="form-group row">
            <div class="col-sm-10">
              <input type="text" class="form-control" id="Ancillary_meas_new" name="Ancillary_meas_new" placeholder="Enter new measurement here">
            </div>
      </div>
...
<!----------------------------------->    
 ...
 <div class="container">
        <header class="section-header">
          <h3 id="howtocontribute">Companion notebook</h3>
<!--           <p></p>
 -->        </header>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <select multiple class="form-control" id="notebook_purpose" name="notebook_purpose">
      ...
      <div class="form-group row">
            <div class="col-sm-10">
              <input type="text" class="form-control" id="notebook_purpose_new" name="notebook_purpose_new" placeholder="Enter new notebook purpose here">
            </div>
      </div>

      <div class="form-group row" enctype="multipart/form-data">
          <label for="notebook" class="col-sm-2 col-form-label">Notebook</label>
          <div class="col-sm-10">
            <input type="file" class="form-control-file" name="notebook">
          </div>
      </div>
        <div class="form-group row">
          <label for="comment" class="col-sm-2 col-form-label">Comment</label>
...
<!--           <p></p>
 -->        </header>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="url" class="form-control" id="dataLink" name="dataLink" placeholder="Enter DOI (if applicable) without URL. e.g. 10.5281/zenodo.2530059">
          </div>
        </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
 ...
 <script> $(".js-example-tags").select2({
  tags: true
});
</script> 
